...
//————————————————————————————————————————————着色器代码————————————————————————————————————————————//
    const char* vsPath = "C:/Users/Yuwei/Desktop/code/OpenGL/vscode/src/04_texture/shader/shader.vs";
    const char* fsPath = "C:/Users/Yuwei/Desktop/code/OpenGL/vscode/src/04_texture/shader/shader.fs";
